    ...
    private Game getGameInterface() {
        ...
        if (getDLCs().isEmpty()) {
            ...
            if (isInsert()) {
                ...
                return new Game(id, titulo, observacao, dataCompra, precoDeCompra, 0, nota, estado, false, console, zerado);
            }
        } else {
            if (isInsert()) {
                return new Game(titulo, observacao, dataCompra, precoDeCompra, 0, nota, estado, false, console, zerado, true, getDLCs());
            } else {
                return new Game(id, titulo, observacao, dataCompra, precoDeCompra, 0, nota, estado, false, console, zerado, true, getDLCs());
            }
        }
    }
    ...
    private void montaAlterarDados(int idGame) {
        try {
            ...
            if (game != null) {
                ...
                tf_data_compra.setText(game.getDataDeCompra());

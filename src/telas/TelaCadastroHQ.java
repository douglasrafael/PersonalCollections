...
public class TelaCadastroHQ extends javax.swing.JDialog {
    ...
    private void montaAlterarDados(int idHQ) {
        try {
            ...
            if (hq != null) {
                ...
                tf_data_compra.setText(hq.getDataDeCompra());
    ...
    private HQ getHQInterface() {
        ...
        if (isInsert()) {
            ...
            return new HQ(getId(), titulo, observacao, dataCompra, precoDeCompra, 0, nota, estado, false, TipoItem.HQ, numero, editora, saga, universo, lido);
        }
    }

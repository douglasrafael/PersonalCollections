...
public class TestTabuleiro {
	...
	private TipoItem tipo = TipoItem.JOGOTABULEIRO;
	
	@Before
	public void criaJogosTabuleiro() {
		listaJogosTabuleiro = new ArrayList<Tabuleiro>();
...
//			System.out.println("TOTAL ITEMS: " + gt.listar().size());
	...
	public void testRemover() {
		try {
			...
			Assert.assertTrue(gt.listar().size() == 0 );
		} catch (PersonalCollectionsException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
...
//		System.out.println(jt1);
		...
		/**
		 * Aqui já testa todos os métodos acessores (get e set) da classe (Tabuleiro) e da classe mãe (Item)
		 */

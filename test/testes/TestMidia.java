...
public class TestMidia {
	...
	private TipoItem tipo = TipoItem.MIDIA;
	...
	public void testPesquisar() {
		try {
			 ...
			 */
			List<Midia> verif_encontrado = new ArrayList<Midia>();
	...
	public void testRemover() {
		try {
			...
			Assert.assertTrue(gerenciadorMidia.listar().size() == 0 );
		} catch (PersonalCollectionsException e) {
			e.printStackTrace();
		}
	}
...
//		System.out.println(m1);
		...
		/**
		 * Aqui já testa todos os métodos acessores (get e set) da classe (Midia) e da classe mãe (Item)
		 */

...
public class TestHQ {
	...
	private TipoItem tipo = TipoItem.HQ;
	...
	public void testPesquisar() {
		try {
			 ...
			 */
			List<HQ> verif_encontrado = new ArrayList<HQ>();
	...
	public void testRemover() {
		try {
			...
			Assert.assertTrue(gerenciadorHQ.listar().size() == 0 );
		} catch (PersonalCollectionsException e) {
			e.printStackTrace();
		}
	}
...
//		System.out.println(hq1);
		...
		/**
		 * Aqui já testa todos os métodos acessores (get e set) da classe (HQ) e da classe mãe (Item)
		 */

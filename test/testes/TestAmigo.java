...
public class TestAmigo {
	...
	public void criaAmigos() {
		listaDeAmigos = new ArrayList<Amigo>();
	...
	public void testPesquisar() {
		try {
			 ...
			 */
			List<Amigo> encontrados = new ArrayList<Amigo>();
	...
	public void testRemover() {
		try {
			...
			Assert.assertTrue(gerenciadorAmigo.listar().size() == 0 );
		} catch (PersonalCollectionsException e) {
			e.printStackTrace();
		}
	}
...
//		System.out.println(amigo2);
		...
		/**
		 * Aqui já testa todos os métodos acessores (get e set) da classe (Amigo) e da classe mãe (Pessoa)
		 */
